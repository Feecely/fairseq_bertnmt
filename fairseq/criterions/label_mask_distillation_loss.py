...
@dataclass
class LabelMaskDistillationLossCriterionConfig(FairseqDataclass):
...
@register_criterion(
    "label_mask_distillation_loss", dataclass=LabelMaskDistillationLossCriterionConfig
)
class LabelMaskDistillationLossCriterion(FairseqCriterion):
    def __init__(
        self,
        task,
        sentence_avg,
