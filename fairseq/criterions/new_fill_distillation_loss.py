...
@dataclass
class NewFillDistillationLossCriterionConfig(FairseqDataclass):
...
@register_criterion(
    "new_fill_distillation_loss", dataclass=NewFillDistillationLossCriterionConfig
)
class NewFillDistillationLossCriterion(FairseqCriterion):
    def __init__(
        self,
        task,
        sentence_avg,
