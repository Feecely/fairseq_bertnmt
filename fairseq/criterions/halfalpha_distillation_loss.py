...
@dataclass
class HalfalphaDistillationLossCriterionConfig(FairseqDataclass):
...
@register_criterion(
    "halfalpha_distillation_loss", dataclass=HalfalphaDistillationLossCriterionConfig
)
class HalfalphaDistillationLossCriterion(FairseqCriterion):
    def __init__(
            self,
            task,
            sentence_avg,
