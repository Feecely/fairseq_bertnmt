...
@dataclass
class NewMaskDistillationLossCriterionConfig(FairseqDataclass):
...
@register_criterion(
    "new_mask_distillation_loss", dataclass=NewMaskDistillationLossCriterionConfig
)
class NewMaskDistillationLossCriterion(FairseqCriterion):
    def __init__(
        self,
        task,
        sentence_avg,
    ...
    def forward(self, model, sample, reduce=True):
        ...
        loss = loss * self.alpha + mask_loss + loss_kd * (1. - self.alpha)
